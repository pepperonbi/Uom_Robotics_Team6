...
def generate_launch_description():
    ...
    pkg_bt_demos = get_package_share_directory('simba_simulation')
    
    # Define nav_to_pose behaviour tree
    bt_xml_navtopose_file = PathJoinSubstitution([pkg_bt_demos, 'behavior_tree_xml', 'bt_example_0.xml'])
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[PathJoinSubstitution([pkg_bt_demos, 'config', 'ekf.yaml'])]
    )
