...
def generate_launch_description():
    ...
    config_bt_nav     = PathJoinSubstitution([pkg_nav_demos, 'config', 'bt_nav_v1.yaml'])
    config_planner    = PathJoinSubstitution([pkg_nav_demos, 'config', 'planner_v1.yaml'])
    config_controller = PathJoinSubstitution([pkg_nav_demos, 'config', 'controller_v1.yaml'])
    ...
    launch_rviz = IncludeLaunchDescription(
     PythonLaunchDescriptionSource([get_package_share_directory('leo_viz'), '/launch', '/view_model.launch.xml']),
     #PythonLaunchDescriptionSource([get_package_share_directory('leo_viz'), '/launch', '/rviz.launch.xml']),
    launch_arguments={}.items(),
    )
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[PathJoinSubstitution([pkg_nav_demos, 'config', 'ekf_v1.yaml'])]
    )
