...
def generate_launch_description():
    ...
    pkg_nav_demos = get_package_share_directory('simba_operation')
    ...
    config_bt_nav     = PathJoinSubstitution([pkg_nav_demos, 'config', 'bt_nav_v2.yaml'])
    config_planner    = PathJoinSubstitution([pkg_nav_demos, 'config', 'planner_v2.yaml'])
    config_controller = PathJoinSubstitution([pkg_nav_demos, 'config', 'controller_v2.yaml'])

    # Include Gazebo Simulation
    launch_gazebo = IncludeLaunchDescription(
     PythonLaunchDescriptionSource([get_package_share_directory('simba_operation'), '/launch', '/display.launch.py']),
     #PythonLaunchDescriptionSource([get_package_share_directory('gz_example_robot_description'), '/launch', '/sim_robot_lidar.launch.py']),
    ...
    robot_localization_node = Node(
       ...
       output='screen',
       parameters=[PathJoinSubstitution([pkg_nav_demos, 'config', 'ekf_v2.yaml'])]
    )
